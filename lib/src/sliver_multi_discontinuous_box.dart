...
class SliverMultiDiscontinuousBoxParentData extends SliverLogicalParentData
...
abstract class RenderSliverMultiDiscontinuousBox extends RenderSliver
    with
        ContainerRenderObjectMixin<RenderBox,
            SliverMultiDiscontinuousBoxParentData>,
        RenderSliverHelpers,
        RenderSliverWithKeepAliveMixin {
  /// Creates a sliver with multiple box children.
  RenderSliverMultiDiscontinuousBox({
  ...
  void setupParentData(RenderObject child) {
    if (child.parentData is! SliverMultiDiscontinuousBoxParentData) {
      child.parentData = SliverMultiDiscontinuousBoxParentData();
    }
  }
  ...
  /// [RenderSliverMultiDiscontinuousBox] uses a [RenderSliverBoxChildManager]
  /// to create children during layout in order to fill the
  ...
  void adoptChild(RenderObject child) {
    ...
    final SliverMultiDiscontinuousBoxParentData childParentData =
        child.parentData! as SliverMultiDiscontinuousBoxParentData;
  ...
  /// see [SliverMultiDiscontinuousBoxParentData.keepAlive].
  ///
  ...
  bool addInitialChild({int index = 0, double layoutOffset = 0.0}) {
    ...
    if (firstChild != null) {
      ...
      final SliverMultiDiscontinuousBoxParentData firstChildParentData =
          firstChild!.parentData! as SliverMultiDiscontinuousBoxParentData;
  ...
  ///
  /// Children whose [SliverMultiDiscontinuousBoxParentData.keepAlive] property is
  ...
  void collectGarbage(List<RenderBox> boxes) {
    assert(_debugAssertChildListLocked());
    invokeLayoutCallback<SliverConstraints>((SliverConstraints constraints) {
      boxes.forEach(_destroyOrCacheChild);
  ...
  /// [SliverMultiDiscontinuousBoxParentData.index] field of the child's [parentData].
